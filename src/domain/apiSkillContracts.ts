...
export const apiSkillContractRegistry: ApiSkillContract[] = [
  ...
  },
  {
    ...
    inputFields: [
      ...
      field(
        ...
        "locale",
        true,
        "Supported runtime locales are the activated set en-US, zh-CN, zh-TW, ja-JP, ko-KR, vi-VN, id-ID, tr-TR, and es-ES.",
        "运行时支持完整已激活语言集合 en-US、zh-CN、zh-TW、ja-JP、ko-KR、vi-VN、id-ID、tr-TR 与 es-ES。",
        "en-US,zh-CN,zh-TW,ja-JP,ko-KR,vi-VN,id-ID,tr-TR,es-ES",
      ),
  ...
  },
  {
    ...
    outputFields: [
      ...
      field("supportedLocales", "locale", true, "Supported locale set for campaign copy.", "活动文案支持的语言集合。", "en-US,zh-CN,zh-TW,ja-JP,ko-KR,vi-VN,id-ID,tr-TR,es-ES"),
  ...
  },
  {
    ...
    inputFields: [
      ...
      field(
        ...
        "locale",
        false,
        "Optional target locales limited to zh-CN, zh-TW, ja-JP, ko-KR, vi-VN, id-ID, tr-TR, and es-ES.",
        "可选目标语言限定 zh-CN、zh-TW、ja-JP、ko-KR、vi-VN、id-ID、tr-TR 与 es-ES。",
        "zh-CN,zh-TW,ja-JP,ko-KR,vi-VN,id-ID,tr-TR,es-ES",
      ),
      field(
        "contentKeys",
        "content",

...
export const apiSkillContractRegistry: ApiSkillContract[] = [
  ...
  },
  {
    ...
    inputFields: [
      ...
      field(
        ...
        "locale",
        true,
        "Supported runtime locales are the activated set en-US, zh-CN, zh-TW, ja-JP, ko-KR, vi-VN, id-ID, and tr-TR.",
        "运行时支持完整已激活语言集合 en-US、zh-CN、zh-TW、ja-JP、ko-KR、vi-VN、id-ID 与 tr-TR。",
        "en-US,zh-CN,zh-TW,ja-JP,ko-KR,vi-VN,id-ID,tr-TR",
      ),
  ...
  },
  {
    ...
    outputFields: [
      ...
      field("supportedLocales", "locale", true, "Supported locale set for campaign copy.", "活动文案支持的语言集合。", "en-US,zh-CN,zh-TW,ja-JP,ko-KR,vi-VN,id-ID,tr-TR"),
  ...
  },
  {
    ...
    inputFields: [
      ...
      field(
        ...
        "locale",
        false,
        "Optional target locales limited to zh-CN, zh-TW, ja-JP, ko-KR, vi-VN, id-ID, and tr-TR.",
        "可选目标语言限定 zh-CN、zh-TW、ja-JP、ko-KR、vi-VN、id-ID 与 tr-TR。",
        "zh-CN,zh-TW,ja-JP,ko-KR,vi-VN,id-ID,tr-TR",
      ),
      field(
        "contentKeys",
        "content",

...
export const apiSkillContractRegistry: ApiSkillContract[] = [
  ...
  },
  {
    ...
    inputFields: [
      ...
      field(
        ...
        "locale",
        true,
        "Supported runtime locales are the activated set en-US, zh-CN, zh-TW, ja-JP, ko-KR, vi-VN, and id-ID.",
        "运行时支持完整已激活语言集合 en-US、zh-CN、zh-TW、ja-JP、ko-KR、vi-VN 与 id-ID。",
        "en-US,zh-CN,zh-TW,ja-JP,ko-KR,vi-VN,id-ID",
      ),
  ...
  },
  {
    ...
    outputFields: [
      ...
      field("supportedLocales", "locale", true, "Supported locale set for campaign copy.", "活动文案支持的语言集合。", "en-US,zh-CN,zh-TW,ja-JP,ko-KR,vi-VN,id-ID"),
  ...
  },
  {
    ...
    inputFields: [
      ...
      field(
        ...
        "locale",
        false,
        "Optional target locales limited to zh-CN, zh-TW, ja-JP, ko-KR, vi-VN, and id-ID.",
        "可选目标语言限定 zh-CN、zh-TW、ja-JP、ko-KR、vi-VN 与 id-ID。",
        "zh-CN,zh-TW,ja-JP,ko-KR,vi-VN,id-ID",
      ),
      field(
        "contentKeys",
        "content",

...
const rewardExecutionRefPattern = /\btransaction[-_ ]?id\b\s*[^\s,.]*|\bpayout[-_ ]?id\b\s*[^\s,.]*|\bcustody[-_ ]?id\b\s*[^\s,.]*|\bdistribution[-_ ]?tx\b\s*[^\s,.]*|\bclaim[-_ ]?transaction\b\s*[^\s,.]*|\bcontract[-_ ]?write\b\s*[^\s,.]*|\bpayout-[a-z0-9._:-]+|\bcustody-[a-z0-9._:-]+|\bdistribution-[a-z0-9._:-]+|\btransaction-[a-z0-9._:-]+|\bclaim-[a-z0-9._:-]+/gi;

...
describe("Admin/Ops shell", () => {
  it("renders review gates, contract boundaries, and export preview", () => {
    ...
    expect(screen.getAllByText(/No live contract transaction/).length).toBeGreaterThan(0);
    expect(screen.getAllByText(/no reward custody/).length).toBeGreaterThan(0);
    expect(screen.getByText("Contract Interface Matrix Console")).toBeInTheDocument();
    expect(screen.getAllByText("Companion contracts").length).toBeGreaterThan(0);
    expect(screen.getAllByText("Contract methods").length).toBeGreaterThan(0);
    expect(screen.getByText("Change matrix")).toBeInTheDocument();
    expect(screen.getByText("Current MVP")).toBeInTheDocument();
    expect(screen.getByText("Recommended V2")).toBeInTheDocument();
    expect(screen.getAllByText("Priority / phase").length).toBeGreaterThan(0);
    expect(screen.getAllByText(/No ABI generation/).length).toBeGreaterThan(0);
    expect(screen.getAllByText(/No live contract transaction/).length).toBeGreaterThan(0);
    expect(screen.getAllByText(/No reward custody \/ no reward distribution/).length).toBeGreaterThan(0);
    expect(screen.getAllByText("CampaignRegistryV2").length).toBeGreaterThan(0);
    expect(screen.getAllByText("CampaignPointsLedgerV2").length).toBeGreaterThan(0);
    expect(screen.getAllByText("ReferralRegistryV2").length).toBeGreaterThan(0);
    expect(screen.getAllByText("EligibilityRootRegistryV2").length).toBeGreaterThan(0);
    expect(screen.getByText("CreateCampaign")).toBeInTheDocument();
    expect(screen.getByText("CommitPointsBatch")).toBeInTheDocument();
    expect(screen.getByText("BindReferral")).toBeInTheDocument();
    expect(screen.getByText("SetEligibilityRoot")).toBeInTheDocument();
    expect(screen.getByText("VerifyEligibilityProof")).toBeInTheDocument();
    expect(screen.getByText("Rewards")).toBeInTheDocument();
    expect(screen.getByText("Multilingual content")).toBeInTheDocument();
    expect(screen.getByText("Wallet type")).toBeInTheDocument();
    expect(screen.getAllByText("Risk flags").length).toBeGreaterThan(0);
    expect(screen.getAllByText(/Campaign OS does not custody or distribute rewards/).length).toBeGreaterThan(0);
    ...
    expect(screen.getAllByText("Localization review").length).toBeGreaterThan(0);
    expect(screen.getAllByText("Risk review").length).toBeGreaterThan(0);
    expect(screen.getByText(/No live template registry/)).toBeInTheDocument();
    expect(screen.getByText("Bridge with eBridge")).toBeInTheDocument();
    expect(screen.getByText("Share campaign post")).toBeInTheDocument();
    expect(screen.getAllByText("EOA only").length).toBeGreaterThan(0);
  ...
  it("switches Admin/Ops copy manually to zh-CN", () => {
    ...
    expect(screen.getByText("8 个模板")).toBeInTheDocument();
    expect(screen.getAllByText("本地化审核").length).toBeGreaterThan(0);
    expect(screen.getAllByText("风险审核").length).toBeGreaterThan(0);
    expect(screen.getByText(/不会连接实时模板 registry/)).toBeInTheDocument();
    expect(screen.getByText("使用 eBridge 跨链")).toBeInTheDocument();
    expect(screen.getByText("分享活动动态")).toBeInTheDocument();
    expect(screen.getAllByText("仅 EOA").length).toBeGreaterThan(0);
    ...
    expect(screen.getByText("合约接口矩阵控制台")).toBeInTheDocument();
    expect(screen.getAllByText("Companion contracts").length).toBeGreaterThan(0);
    expect(screen.getAllByText("合约方法").length).toBeGreaterThan(0);
    expect(screen.getByText("变更矩阵")).toBeInTheDocument();
    expect(screen.getByText("当前 MVP")).toBeInTheDocument();
    expect(screen.getByText("建议 V2")).toBeInTheDocument();
    expect(screen.getAllByText("优先级 / 阶段").length).toBeGreaterThan(0);
    expect(screen.getAllByText(/不会生成 ABI/).length).toBeGreaterThan(0);
    expect(screen.getAllByText(/不会执行真实合约交易/).length).toBeGreaterThan(0);
    expect(screen.getAllByText(/不托管奖励 \/ 不发奖/).length).toBeGreaterThan(0);
    expect(screen.getAllByText("CampaignRegistryV2").length).toBeGreaterThan(0);
    expect(screen.getAllByText("CampaignPointsLedgerV2").length).toBeGreaterThan(0);
    expect(screen.getAllByText("ReferralRegistryV2").length).toBeGreaterThan(0);
    expect(screen.getAllByText("EligibilityRootRegistryV2").length).toBeGreaterThan(0);
    ...
    expect(screen.getByText("多语言内容")).toBeInTheDocument();
    expect(screen.getByText("钱包类型")).toBeInTheDocument();
    expect(screen.getAllByText("风险标记").length).toBeGreaterThan(0);
    expect(screen.getAllByText(/Campaign OS 不托管也不发放奖励/).length).toBeGreaterThan(0);

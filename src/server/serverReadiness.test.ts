      ...
      readiness: {
        ...
        authSession: {
          ...
          foundation: {
            ...
            status: "local_ready",
            valid: true,
            walletProof: expect.objectContaining({
              liveVerificationExecuted: false,
      ...
      expect(withMetadata.data).toMatchObject({
        ...
        serverRuntime: expect.objectContaining({
          ...
          readiness: expect.objectContaining({
            ...
            schedulerRuntimeFoundation: expect.objectContaining({
              dryRunTriggerEnabled: true,
              id: "campaign-os-scheduler-runtime-foundation",
              productionReady: false,
              registrationCount: 9,
            }),
            queueRuntimeFoundation: expect.objectContaining({
              providerAdapter: expect.objectContaining({
                adapterId: "local-dry-run-queue-provider-adapter",
                liveQueuePublishingEnabled: false,
                liveWorkerExecutionEnabled: false,
                mode: "dry_run",
            ...
            workerLeaseStoreFoundation: expect.objectContaining({
              adapterId: "local-dry-run-worker-lease-store-adapter",
              liveQueuePublishingEnabled: false,
              liveWorkerExecutionEnabled: false,
              mode: "dry_run",
            ...
            workerIdempotencyStoreFoundation: expect.objectContaining({
              adapterId: "local-dry-run-worker-idempotency-store-adapter",
              liveIdempotencyExecutionEnabled: false,
              liveQueuePublishingEnabled: false,
              liveWorkerExecutionEnabled: false,

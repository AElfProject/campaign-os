...
export const apiServicePorts = [
  ...
  servicePort({
    ...
    notes: "Seeded verification exists; provider evidence, queue provider SDK package installation, real broker connection, SDK binding registration, and async live worker execution are deferred.",
    productionAdapterStatus: "local_seeded",
    requiresExternalNetwork: false,
    requiresSecret: false,

...
export const apiServicePorts = [
  servicePort({
    ...
    notes: "Local runtime and contract metadata are available; production observability backend is not selected.",
  ...
  servicePort({
    ...
    notes: "Seeded verification exists; provider evidence and async worker execution are deferred.",
    productionAdapterStatus: "local_seeded",
    requiresExternalNetwork: false,
    requiresSecret: false,

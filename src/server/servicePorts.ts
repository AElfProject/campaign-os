...
export const apiServicePorts = [
  ...
  servicePort({
    ...
    notes: "Campaign discovery, draft creation, lifecycle operation inspection, and launch readiness inspection use local seeded data; durable storage, mutation audit, scheduler handoff, and auth are deferred.",
    productionAdapterStatus: "local_seeded",
    requiresExternalNetwork: false,
    requiresSecret: false,
    routeIds: [
  ...
  servicePort({
    ...
    notes: "Export preview and export readiness inspection are local; storage-backed files and contract writes are deferred or disabled.",
    productionAdapterStatus: "local_seeded",
    requiresExternalNetwork: false,
    requiresSecret: false,

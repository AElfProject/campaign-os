...
export const apiServicePorts = [
  ...
  servicePort({
    ...
    futureAttachPoints: [
      ...
      "queue provider driver SDK binding",
    ...
    notes: "Seeded verification exists; provider evidence, queue provider driver SDK binding, and async worker execution are deferred.",
    productionAdapterStatus: "local_seeded",
    requiresExternalNetwork: false,
    requiresSecret: false,

...
const backendSurfaceReadiness = [
  ...
  },
  {
    deferredDependencies: ["auth_session", "production_database"],
    label: "Campaign",
    notes: "Local campaign discovery and draft creation exist; durable storage and owner auth are deferred.",
  ...
  },
  {
    ...
    label: "Analytics",
    notes: "Local analytics summary exists; warehouse-backed analytics are deferred.",
  ...
  },
  {
    ...
    notes: "Topology exists; production ledger, ranking persistence, and optional root publication are deferred.",
    routeIds: [],
  ...
  },
  {
    ...
    notes: "Local health, contracts, route coverage, and topology reporting exist.",

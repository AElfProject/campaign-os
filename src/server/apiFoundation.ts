...
const requestFieldContracts = [
  ...
  field({
    description: "Optional Participant wallet address compatibility claim.",
    id: "campaigns.points.ranking.ledger.runtime.query.walletAddress",
    location: "query",
    name: "walletAddress",
    required: false,
    routeId: "campaigns.points.ranking.ledger.runtime",
  ...
  field({
    description: "Alternative Participant wallet address compatibility claim.",
    id: "campaigns.points.ranking.ledger.runtime.query.address",
    location: "query",
    name: "address",
    required: false,
    routeId: "campaigns.points.ranking.ledger.runtime",
  ...
  field({
    description: "Optional Participant account type compatibility claim.",
    enumValues: ["AA", "EOA", "UNKNOWN"],
    id: "campaigns.points.ranking.ledger.runtime.query.accountType",
    location: "query",
    name: "accountType",
    required: false,
    routeId: "campaigns.points.ranking.ledger.runtime",
  ...
  field({
    description: "Optional Participant wallet source compatibility claim.",
    enumValues: [
      "PORTKEY_AA",
      "PORTKEY_EOA_APP",
    ...
    id: "campaigns.points.ranking.ledger.runtime.query.walletSource",
    location: "query",
    name: "walletSource",
    required: false,
    routeId: "campaigns.points.ranking.ledger.runtime",
  ...
  field({
    description: "Optional Participant chain identifier compatibility claim.",
    id: "campaigns.points.ranking.ledger.runtime.query.chainId",
    location: "query",
    name: "chainId",
    required: false,
    routeId: "campaigns.points.ranking.ledger.runtime",
  ...
  field({
    description: "Optional Participant network compatibility claim.",
    enumValues: ["mainnet", "testnet"],
    id: "campaigns.points.ranking.ledger.runtime.query.network",
    location: "query",
    name: "network",
    required: false,
    routeId: "campaigns.points.ranking.ledger.runtime",

...
const backendSurfaceReadiness = [
  ...
  },
  {
    ...
    label: "Campaign",
    notes: "Local campaign discovery and draft creation exist; durable storage, owner auth, scheduler runtime, and worker queue lifecycle handoff are deferred.",
  ...
  },
  {
    ...
    label: "Verification",
    notes: "Local seeded verification exists; provider/indexer handoff, provider evidence, worker queue, scheduler runtime, retry/backoff, idempotency store, and worker lease are deferred with pending/manual_review degradation.",
  ...
  },
  {
    ...
    label: "Eligibility",
    notes: "Local eligibility checks exist; live indexer/provider evidence stays pending or manual review while scheduler runtime, worker queue, idempotency store, and risk stores are deferred.",
  ...
  },
  {
    ...
    label: "Analytics",
    notes: "Local analytics summary exists; warehouse-backed analytics ingestion, scheduler runtime, worker queue, idempotency store, and observability exporter are deferred.",
  ...
  },
  {
    ...
    label: "Export",
    notes: "Local export preview exists; object storage adapter fulfillment, export preparation worker handoff, idempotency store, observability exporter, and contract root writes are deferred.",
  ...
  },
  {
    ...
    notes: "Topology exists; production ledger, ranking persistence, reward handoff worker queue, idempotency store, observability exporter, and optional root publication are deferred.",
    routeIds: [],
  ...
  },
  {
    deferredDependencies: ["production_database", "provider_adapters", "scheduler", "worker_queue"],
    label: "Risk Scoring",
    notes: "Topology exists; analytics warehouse adapter ingestion, scheduler runtime, worker queue, worker lease, and scoring workers are deferred.",
    routeIds: [],
  ...
  },
  {
    ...
    label: "AI Ops",
    notes: "Topology exists; AI provider adapter calls, approval flow, scheduler runtime, observability exporter, and worker execution are deferred.",
    routeIds: [],
  ...
  },
  {
    ...
    notes: "Local health, contracts, route coverage, and topology reporting exist; contract sync handoff depends on deferred scheduler runtime, worker queue, idempotency store, and observability exporter.",

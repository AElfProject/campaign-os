...
describe("queue runtime foundation", () => {
  ...
  it("keeps local review deterministic, valid, and free of live execution", () => {
    ...
    expect(foundation.readiness).toMatchObject({
      ...
      providerAdapterDriverConsumeAttemptPolicy: "disabled_no_live",
      providerAdapterDriverConsumeRequestEvaluated: false,
      providerAdapterDriverConsumeResultStatus: "not_requested",
      providerAdapterDriverConsumingActivationStatus: "disabled",
      providerAdapterDriverConsumingConsumerId: "not_configured",
      providerAdapterDriverConsumingConsumerProvided: false,
      providerAdapterDriverConsumingHandlerRegistryProvided: false,
      providerAdapterDriverConsumingLiveQueueConsumptionEnabled: false,
      providerAdapterDriverConsumingStatus: "disabled",
      ...
      providerAdapterDriverSdkBindingPackageBindingBlockerCount: 0,
      providerAdapterDriverSdkBindingPackageBindingBrowserBundleAllowed: false,
      providerAdapterDriverSdkBindingPackageBindingBullmqConstructionAttempted: false,
      providerAdapterDriverSdkBindingPackageBindingBullmqConstructionBlockerCount: 0,
      providerAdapterDriverSdkBindingPackageBindingBullmqConstructionDiagnosticCodes: [],
      providerAdapterDriverSdkBindingPackageBindingBullmqConstructionFactoryInvoked: false,
      providerAdapterDriverSdkBindingPackageBindingBullmqConstructionId: "bullmq-construction-local",
      providerAdapterDriverSdkBindingPackageBindingBullmqConstructionProductionReady: false,
      providerAdapterDriverSdkBindingPackageBindingBullmqConstructionStatus: "local_ready",
      providerAdapterDriverSdkBindingPackageBindingFamily: "bullmq-redis-compatible",
      providerAdapterDriverSdkBindingPackageBindingId: "bullmq-redis-package-binding-local",
      ...
      providerAdapterDriverSdkBindingPackageBindingStatus: "local_ready",

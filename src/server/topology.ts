...
export const backendServiceBoundaries = [
  service({
    ...
    risks: ["Production persistence and auth/session are deferred."],
  ...
  service({
    ...
    productionRequired: true,
    readiness: "deferred",
    risks: ["Production ledger and optional contract transparency are deferred."],
    routeIds: [],
  ...
  service({
    ...
    productionRequired: true,
    readiness: "review_required",
    risks: ["Storage-backed exports and contract writes are disabled/deferred."],
  ...
  service({
    ...
    productionRequired: true,
    readiness: "deferred",
    risks: ["Risk event ingestion and warehouse integrations are deferred."],
    routeIds: [],
    runtimeProfiles: productionRequiredProfiles,
  }),
  service({
  ...
  service({
    ...
    productionRequired: true,
    readiness: "deferred",
    risks: ["AI provider, approval flow, and worker execution are deferred."],
    routeIds: [],
    runtimeProfiles: productionRequiredProfiles,
  }),
  service({
  ...
  service({
    ...
    productionRequired: true,
    readiness: "ready",
    risks: ["Production observability backend is not selected yet."],
